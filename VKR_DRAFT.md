...
Основной вклад автора сосредоточен в веб-клиенте, реализованном на серверном рендеринге Django templates. Этот контур включает проектирование пользовательских сценариев, построение административных интерфейсов и согласование UI-логики с backend-ограничениями. Технически реализация опирается на Django view-функции, серверные формы и встроенную валидацию, поэтому операции в интерфейсе напрямую соответствуют доменным правилам системы.
