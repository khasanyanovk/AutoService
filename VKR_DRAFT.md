...
2. ведение карточек автомобилей (бренд, модель, VIN, номер) с возможностью использования истории записей на обслуживание и связанных статусов в последующих обращениях;
...
- часть внешних интеграций реализована в стартовом объеме: платежный модуль покрывает базовый сценарий оплаты услуги, а уведомления ограничены основными почтовыми событиями без расширенных многоканальных коммуникаций;
