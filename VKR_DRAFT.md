...
2. ведение карточек автомобилей (бренд, модель, VIN, номер) с возможностью использования истории обслуживания автомобилей в последующих записях;
...
- часть внешних интеграций (прежде всего платежный провайдер и механизмы уведомлений) реализована базово и требует поэтапного расширения по мере уточнения требований и накопления эксплуатационного опыта;
