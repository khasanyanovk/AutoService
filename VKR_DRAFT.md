...
2. ведение карточек автомобилей (бренд, модель, VIN, номер) с возможностью использования истории автомобилей в последующих записях;
...
- часть внешних интеграций реализована базово и требует поэтапного расширения по мере уточнения требований и накопления эксплуатационного опыта;
